...
public class EncumbranceReleasedEventHandler : INotificationHandler<EncumbranceReleasedEvent>
{
    private readonly IMediator _mediator;
    // In a real system, you'd need the Encumbrance Control Account.

    public EncumbranceReleasedEventHandler(IMediator mediator)
    {
        _mediator = mediator;
    }

    public async Task Handle(EncumbranceReleasedEvent notification, CancellationToken cancellationToken)
    {
        ...
        var createJournalEntryCommand = new CreateJournalEntryCommand
        {
            ...
            Description = $"Journal entry for released encumbrance {notification.EncumbranceId}",
