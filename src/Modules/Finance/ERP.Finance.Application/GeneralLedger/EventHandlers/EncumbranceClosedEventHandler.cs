...
public class EncumbranceClosedEventHandler : INotificationHandler<EncumbranceClosedEvent>
{
    private readonly IMediator _mediator;
    // In a real system, you'd need the Encumbrance Control Account.

    public EncumbranceClosedEventHandler(IMediator mediator)
    {
        _mediator = mediator;
    }

    public async Task Handle(EncumbranceClosedEvent notification, CancellationToken cancellationToken)
    {
        ...
        var createJournalEntryCommand = new CreateJournalEntryCommand
        {
            ...
            Description = $"Journal entry for closed encumbrance {notification.EncumbranceId}",
