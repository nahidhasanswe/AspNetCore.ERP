...
public class TransferAssetCommandHandler(IFixedAssetRepository fixedAssetRepository, IUnitOfWorkManager unitOfWork)
    : IRequestHandler<TransferAssetCommand, Result>
{
    public async Task<Result> Handle(TransferAssetCommand command, CancellationToken cancellationToken)
    {
